...
import { OctagonAlertIcon, SquareDashedMousePointer } from "lucide-react";
        ...
        <CardContent className="grid p-0  md:grid-cols-2">
          ...
          <div className="bg-primary relative hidden md:flex flex-col gap-y-4 items-center justify-center">
            <div className="rounded-xl bg-emerald-400 p-2">
              <SquareDashedMousePointer className="h-[92px] w-[92px] stroke-white" />
            </div>
            <div className="text-3xl font-extrabold">
              <span className="text-emerald-400">Scrape</span>
              <span className="text-stone-200">Flow</span>
            </div>
          </div>
        </CardContent>
      </Card>
